...
'''
@File    :   MUCNN.py
@Time    :   2023/07/03 01:58:13
@Author  :   Liuch(laxio) 
@Version :   1.0
@Source  :   SSconv: Explicit Spectral-to-Spatial Convolution for Pansharpening(ACM MM2021)
@Note    :   batch_size = 32, learning_rate = 1e-3, L1, 600 epoch, decay 200, x0.1, ADAM
...
#         # print(x5.shape)
#         return x3, x4, x5
from modules.UD import UPPCM, DPPCM
class Network(nn.Module):

    def __init__(self, pan_channels, ms_channels, args):
        super(Network, self).__init__()
        spectral_num = ms_channels
        upscale1 = 2
        upscale2 = 4
        #   up_2
        self.conv_up1 = UPPCM(spectral_num, upscale1)
        self.conv_up2 = UPPCM(spectral_num, upscale2)
        ...
        self.conv3 = Conv(channel_input3, channel_output3)
        channel_input4 = channel_output3 + channel_output2
        self.up1 = UPPCM(channel_output3, 2)
        channel_output4 = 144
        self.conv4 = Conv(channel_input4, channel_output4)
        channel_input5 = channel_output1 + channel_output4
        self.up2 = UPPCM(channel_output4, 2)
        channel_output5 = 36
        self.conv5 = Conv(channel_input5, channel_output5)
