...
'''
@File    :   TDNET.py
@Time    :   2023/07/03 11:56:33
@Author  :   Liuch(laxio) 
@Version :   1.0
@Source  :   A Triple-Double Convolutional Neural Network for Panchromatic Sharpening(IEEE Transactions on Neural Networks and Learning Systems, 2022)
@Note    :   batch_size = 32, learning_rate = 1e-2, L2, 300 epoch, decay 220, x0.1, ADAM
