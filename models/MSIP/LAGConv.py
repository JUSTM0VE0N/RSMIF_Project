...
'''
@File    :   LAGConv.py
@Time    :   2023/07/03 01:53:27
@Author  :   Liuch(laxio) 
@Version :   1.0
@Source  :   LAGConv: Local-context Adaptive Convolution Kernels with Global Harmonic Bias for Pansharpening(AAAI2022)
@Note    :   batch_size = 32, learning_rate = 1e-3, L2, 1000 epoch, decay 500, x0.1, ADAM
...
class Network(nn.Module):
    def __init__(self, args):
        ...
        self.head_conv = nn.Sequential(
            LAConv2D(9, 32, 3, 1, 1, use_bias=True),   # 5, 32, 3, 1, 1
            nn.ReLU(inplace=True)
        )
        ...
        self.tail_conv = LAConv2D(32, 8, 3, 1, 1, use_bias=True)  # 32, 4, 3, 1, 1
